...
type RegistryService interface {
	...
	Mark(ctx context.Context, in *MarkRequest, opts ...client.CallOption) (*EmptyResponse, error)
	Reset(ctx context.Context, in *ResetRequest, opts ...client.CallOption) (*EmptyResponse, error)
...
func (c *registryService) Mark(ctx context.Context, in *MarkRequest, opts ...client.CallOption) (*EmptyResponse, error) {
	req := c.c.NewRequest(c.name, "Registry.Mark", in)
	out := new(EmptyResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *registryService) Reset(ctx context.Context, in *ResetRequest, opts ...client.CallOption) (*EmptyResponse, error) {
	req := c.c.NewRequest(c.name, "Registry.Reset", in)
	out := new(EmptyResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *registryService) GetServices(ctx context.Context, in *GetServicesRequest, opts ...client.CallOption) (*GetServicesResponse, error) {
	req := c.c.NewRequest(c.name, "Registry.GetServices", in)
...
type RegistryHandler interface {
	...
	Mark(context.Context, *MarkRequest, *EmptyResponse) error
...
func RegisterRegistryHandler(s server.Server, hdlr RegistryHandler, opts ...server.HandlerOption) error {
	type registry interface {
		...
		Mark(ctx context.Context, in *MarkRequest, out *EmptyResponse) error
		Reset(ctx context.Context, in *ResetRequest, out *EmptyResponse) error
...
func (h *registryHandler) Mark(ctx context.Context, in *MarkRequest, out *EmptyResponse) error {
	return h.RegistryHandler.Mark(ctx, in, out)
}

func (h *registryHandler) Reset(ctx context.Context, in *ResetRequest, out *EmptyResponse) error {
	return h.RegistryHandler.Reset(ctx, in, out)
}

func (h *registryHandler) GetServices(ctx context.Context, in *GetServicesRequest, out *GetServicesResponse) error {
	return h.RegistryHandler.GetServices(ctx, in, out)
}
